...
export const selectWeekReverse = createSelector([selectHistory], (week) =>
  reverseData(week.week)
);
export const selectMonthReverse = createSelector([selectHistory], (month) =>
  reverseData(month.month)
);
export const selectYearReverse = createSelector([selectHistory], (year) =>
  reverseData(year.year)
);
